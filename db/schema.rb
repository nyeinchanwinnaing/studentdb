...
ActiveRecord::Schema[7.0].define(version: 2023_09_28_071839) do
  ...
  create_table "project_evaluations", force: :cascade do |t|
    ...
    t.index ["student_id"], name: "index_project_evaluations_on_student_id"
  end
  ...
  add_foreign_key "project_evaluations", "students"
